...
@tbl-one describes the average beats per minute, energy, liveness, danceability, valence, length, acousticness, speechiness, popularity of the top 50 songs from Spotify in 2019, stratified by genre.
...
#| message: false
#| label: tbl-one
#| tbl-cap: Song Track Characteristics by Genre
